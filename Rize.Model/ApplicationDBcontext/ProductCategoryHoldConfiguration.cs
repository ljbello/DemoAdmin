...
public partial class ProductCategoryHoldConfiguration : IEntityTypeConfiguration<ProductCategoryHold>
{
    public void Configure(EntityTypeBuilder<ProductCategoryHold> entity)
    {
        entity
                .HasNoKey()
                .ToTable("ProductCategoryHold");
    ...
    partial void OnConfigurePartial(EntityTypeBuilder<ProductCategoryHold> entity);
}

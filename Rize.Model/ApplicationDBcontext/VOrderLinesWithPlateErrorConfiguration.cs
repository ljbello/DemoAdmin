...
public partial class VOrderLinesWithPlateErrorConfiguration : IEntityTypeConfiguration<VOrderLinesWithPlateError>
{
    public void Configure(EntityTypeBuilder<VOrderLinesWithPlateError> entity)
    {
        entity
                .HasNoKey()
                .ToView("vOrderLinesWithPlateErrors");
    ...
    partial void OnConfigurePartial(EntityTypeBuilder<VOrderLinesWithPlateError> entity);
}
